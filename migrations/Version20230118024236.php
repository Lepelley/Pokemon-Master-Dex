 ...
 */
final class Version20230118024236 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pokemon (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, national_number INT DEFAULT NULL, is_online TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_pokedex_pokemon (id INT AUTO_INCREMENT NOT NULL, capture_ball_id INT DEFAULT NULL, capture_game_id INT DEFAULT NULL, pokedex_id INT NOT NULL, pokemon_id INT NOT NULL, is_captured TINYINT(1) NOT NULL, notes LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_AFDF155A8472455E (capture_ball_id), INDEX IDX_AFDF155A96220CC3 (capture_game_id), INDEX IDX_AFDF155A372A5D14 (pokedex_id), INDEX IDX_AFDF155A2FE71C3E (pokemon_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
