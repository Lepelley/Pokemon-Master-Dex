 ...
 */
final class Version20230113012144 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_pokedex_pokemon ADD CONSTRAINT FK_AFDF155A904D9BF8 FOREIGN KEY (user_pokedex_id) REFERENCES user_pokedex (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
