 ...
 */
final class Version20231121145715 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pokedex_pokemon (id INT AUTO_INCREMENT NOT NULL, pokemon_id INT NOT NULL, pokedex_id INT NOT NULL, regional_number INT DEFAULT NULL, specific_name VARCHAR(255) DEFAULT NULL, specific_image VARCHAR(255) DEFAULT NULL, specific_shiny_image VARCHAR(255) DEFAULT NULL, is_shiny_unavailable TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_BD0379D52FE71C3E (pokemon_id), INDEX IDX_BD0379D5372A5D14 (pokedex_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_pokedex (id INT AUTO_INCREMENT NOT NULL, trainer_id INT NOT NULL, base_game_id INT DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, is_shiny TINYINT(1) NOT NULL, prevent_spoil TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_3B3BE8ADFB08EDF6 (trainer_id), INDEX IDX_3B3BE8ADD0896061 (base_game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_pokedex_pokemon (id INT AUTO_INCREMENT NOT NULL, capture_ball_id INT DEFAULT NULL, capture_game_id INT DEFAULT NULL, pokedex_id INT NOT NULL, form_id INT DEFAULT NULL, pokemon_id INT NOT NULL, is_captured TINYINT(1) NOT NULL, notes LONGTEXT DEFAULT NULL, regional_number INT DEFAULT NULL, specific_name VARCHAR(255) DEFAULT NULL, specific_image VARCHAR(255) DEFAULT NULL, specific_shiny_image VARCHAR(255) DEFAULT NULL, is_shiny_unavailable TINYINT(1) NOT NULL, is_male TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_AFDF155A8472455E (capture_ball_id), INDEX IDX_AFDF155A96220CC3 (capture_game_id), INDEX IDX_AFDF155A372A5D14 (pokedex_id), INDEX IDX_AFDF155A5FF69B7D (form_id), INDEX IDX_AFDF155A2FE71C3E (pokemon_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE user_pokedex_pokemon ADD CONSTRAINT FK_AFDF155A2FE71C3E FOREIGN KEY (pokemon_id) REFERENCES pokemon (id)');
    }
